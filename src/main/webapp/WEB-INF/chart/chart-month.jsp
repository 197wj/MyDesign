...
<body>
	...
	<nav class="breadcrumb">
		...
		图形信息 <span class="c-gray en">&gt;</span> 农田月报表 <a
	...
	<div class="text-c"> 日期范围：
		<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'monthTime\')||\'%y-%M-%d\'}'})" id="monthTime" class="input-text Wdate" style="width:170px;">
 ...
 */
 $("#seach").click(function(){
	...
	monthChart(monthTime,farmlandId);
 });
 
 
function monthChart(monthTime,farmlandId){
	var chart=null;

	$.ajax({
		url:'../report/getMonthReport.action',
		type:'get',
		data:{'monthTime':monthTime,'farmlandId':farmlandId},
		dataType:'json',
