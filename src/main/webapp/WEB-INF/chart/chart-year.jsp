...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span> 农田年报表 
...
<br>
	<div class="text-c"> 日期范围：
		<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'startTime\')||\'%y-%M-%d\'}'})" id="startTime" class="input-text Wdate" style="width:170px;">
 ...
 */
 $("#seach").click(function(){
	...
	var yearTime = $("#startTime").val();
	dayChart(farmlandId,yearTime);
 });
 
 
function dayChart(farmlandId,yearTime){
	var chart=null;

	$.ajax({
		url:'../report/getYearReport.action',
		type:'get',
		data:{'farmlandId':farmlandId,'yearTime':yearTime},
		dataType:'json',
